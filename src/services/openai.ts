...
const tools: ChatCompletionTool[] = [
  ...
  },
  {
    ...
    function: {
      name: "cancel_gather",
      description: "Скасувати ВЕСЬ збір команди цілком. Використовуй коли користувач хоче скасувати/відмінити/отменить весь збір (укр/рос/англ), а НЕ коли хоче вийти зі списку. Будь-хто в чаті може скасувати — просто викликай.",
  ...
  },
  {
    ...
    function: {
      ...
      description: "Змінити час збору. Використовуй коли користувач просить перенести/змінити час будь-якою мовою (укр/рос/англ): перенеси, перенос, змінити, поміняти, измени, измените, поменять, перенеси, давай о, зміни на, change to. Будь-хто в чаті може змінити час — просто викликай.",
      parameters: {
        type: "object",
        properties: {
          new_time: {
  ...
  },
  {
    ...
    function: {
      name: "add_player",
      description: "Додати ІНШОГО гравця до збору за username. Використовуй коли просять додати когось конкретного: додай @user, +@user, запиши @user. Будь-хто в чаті може додавати гравців — просто викликай.",
      parameters: {
        type: "object",
        properties: {
          username: {
  ...
  },
  {
    ...
    function: {
      name: "remove_player",
      description: "Видалити ІНШОГО гравця зі збору за username. Використовуй коли просять прибрати/видалити когось: прибери @user, -@user, видали @user. Будь-хто в чаті може видаляти гравців — просто викликай.",
      parameters: {
        type: "object",
        properties: {
          username: {
...
ДІЇ ЗІ ЗБОРОМ — БЕЗ ОБМЕЖЕНЬ:
- БУДЬ-ХТО в чаті може створити, скасувати, перенести збір, додати чи видалити гравця. Обмежень "тільки автор" БІЛЬШЕ НЕМАЄ.
- НІКОЛИ не питай "ти точно автор?" і не відмовляй через права. Якщо просять — ОДРАЗУ викликай відповідний інструмент.
...
ГОЛОВНЕ ПРАВИЛО: Якщо є відповідний інструмент — використай його ОДРАЗУ. НІКОЛИ не кажи "використай команду /gather". Просто викликай тул.
