...
const CREATE_GATHER_PATTERN =
  /(?:создай сбор|створи збір|збір на|сбор на|збери команду|собери команду|катка на|граємо о|играем в|грати о|играть в|зроби збір|зроби гру|давай збір|давай на|давай о|грати на|грати в|хочу грати|пограти о|пограти на|го на|го в|го о)\s*(\d{1,2}:\d{2})/i;
